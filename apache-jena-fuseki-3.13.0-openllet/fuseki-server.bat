...
@REM SET CLASSPATH=%CLASSPATH%;run/extra/*
@REM forfiles /M .\run\extra\*.jar /C "cmd /c set CLASSPATH=%CLASSPATH%;@file"
...
java  -Xmx1200M -cp "fuseki-server.jar;run/extra/*" org.apache.jena.fuseki.cmd.FusekiCmd %*
